          ...
          <>
            ...
            <div className="space-y-3">
              ...
              {rights.sections.map((section) => {
                ...
                return (
                  <div key={section.key} className="rounded-lg border border-gray-200/40 bg-white/50 shadow-sm overflow-hidden">
                    <button
                      onClick={() => toggleSection(section.key)}
                      className="w-full flex items-center justify-between p-4 sm:p-5 text-left hover:bg-gray-50/50 transition-colors"
                    >
                      <h3 className="text-sm sm:text-base font-semibold text-gray-900 pr-4">{section.title}</h3>
                      {isOpen ? (
                    ...
                    {isOpen && (
                      <div className="px-4 pb-4 sm:px-5 sm:pb-5 border-t border-gray-100">
                        ...
                        <div className="mt-4">
                          <h4 className="text-xs font-semibold uppercase tracking-wide text-blue-600 mb-2">Key Points</h4>
                          <ul className="space-y-1.5">
            ...
            {/* Court Filing Tips */}
            <div className="rounded-lg border border-amber-200 bg-amber-50/50 p-4 sm:p-6 shadow-sm">
