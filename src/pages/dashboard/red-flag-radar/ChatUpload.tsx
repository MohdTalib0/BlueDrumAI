      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        {error && (
          <div className="mb-6 animate-in slide-in-from-top-5 flex items-center gap-3 rounded-lg border border-red-200 bg-red-50 p-4 text-red-800 shadow-sm dark:bg-black dark:border-red-700/40 dark:text-red-300">
            ...
            <button onClick={() => setError('')} className="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300">
              <X className="h-4 w-4" />
            </button>
          </div>
        )}
        ...
        <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <button
            ...
            className="group rounded-lg border border-blue-200 bg-blue-50/50 p-5 text-left transition-all hover:border-blue-300 hover:bg-blue-100 hover:shadow-md dark:bg-black dark:border-primary-500/20 dark:hover:border-primary-500/30"
          >
            <div className="mb-3 flex items-center gap-2">
              <GitCompare className="h-5 w-5 text-blue-600" />
              <h3 className="font-semibold text-blue-900 dark:text-white">Compare Analyses</h3>
            </div>
            ...
            <div className="mt-3 text-xs font-medium text-blue-700 group-hover:text-blue-900 dark:text-gray-400 dark:group-hover:text-white">
              Compare now →
            </div>
          </button>
          ...
          <button
            ...
            className="group rounded-lg border border-purple-200 bg-purple-50/50 p-5 text-left transition-all hover:border-purple-300 hover:bg-purple-100 hover:shadow-md dark:bg-black dark:border-primary-500/20 dark:hover:border-primary-500/30"
          >
            <div className="mb-3 flex items-center gap-2">
              <BookOpen className="h-5 w-5 text-purple-600" />
              <h3 className="font-semibold text-purple-900 dark:text-white">Red Flag Experience</h3>
            </div>
            ...
            <div className="mt-3 text-xs font-medium text-purple-700 group-hover:text-purple-900 dark:text-gray-400 dark:group-hover:text-white">
              Learn now →
            </div>
          </button>
          ...
          <button
            ...
            className="group rounded-lg border border-red-200 bg-red-50/50 p-5 text-left transition-all hover:border-red-300 hover:bg-red-100 hover:shadow-md dark:bg-black dark:border-primary-500/20 dark:hover:border-primary-500/30"
          >
            <div className="mb-3 flex items-center gap-2">
              <Bot className="h-5 w-5 text-red-600" />
              <h3 className="font-semibold text-red-900 dark:text-white">Demo Red Flag</h3>
            </div>
            <p className="text-sm text-red-800 dark:text-gray-300">
              Chat with an AI that demonstrates red flag behaviors. Learn to recognize manipulation in real-time.
            </p>
            <div className="mt-3 text-xs font-medium text-red-700 group-hover:text-red-900 dark:text-gray-400 dark:group-hover:text-white">
              Try it now →
            </div>
          </button>
        </div>
        ...
        {/* Platform Selection */}
        <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50/50 p-4 sm:p-6 shadow-sm dark:bg-black dark:border-primary-500/20">
          <h3 className="mb-4 text-base font-semibold text-blue-900 dark:text-white">Select Communication Platform</h3>
              ...
              return (
                <button
                  ...
                  className={`rounded-lg border-2 p-3 sm:p-4 text-left transition-all ${
                    isSelected
                      ? 'border-blue-500 bg-blue-100 shadow-md dark:border-primary-500 dark:bg-black'
                      : 'border-gray-200 bg-white hover:border-blue-300 hover:bg-blue-50 dark:border-gray-700 dark:bg-black/80 dark:hover:border-primary-500/30 dark:hover:bg-primary-900/20'
                  }`}
                >
                  <div className="flex items-center gap-2 mb-2">
                    <Icon className={`h-5 w-5 ${isSelected ? 'text-blue-600' : 'text-gray-600'}`} />
                    <span className={`font-semibold text-sm ${isSelected ? 'text-blue-900 dark:text-primary-300' : 'text-gray-900 dark:text-white'}`}>
                      {p.label}
                    </span>
                  </div>
        ...
        {/* Instructions */}
        {platform === 'whatsapp' && (
          <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50/50 p-6 shadow-sm dark:bg-black dark:border-primary-500/20">
            <div className="flex items-start gap-3">
              <Info className="h-5 w-5 shrink-0 text-blue-600 mt-0.5" />
              <div className="flex-1">
                <h3 className="mb-2 text-base font-semibold text-blue-900 dark:text-white">How to Export WhatsApp Chat</h3>
                <ol className="space-y-2 text-sm text-blue-800 dark:text-gray-300">
        ...
        {platform === 'sms' && (
          <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50/50 p-4 sm:p-6 shadow-sm dark:bg-black dark:border-primary-500/20">
            <div className="flex items-start gap-3">
              <Info className="h-5 w-5 shrink-0 text-blue-600 mt-0.5" />
              <div className="flex-1">
                <h3 className="mb-2 text-base font-semibold text-blue-900 dark:text-white">How to Export SMS</h3>
                <div className="space-y-3 text-sm text-blue-800 dark:text-gray-300">
                  <div>
        ...
        {platform === 'email' && (
          <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50/50 p-4 sm:p-6 shadow-sm dark:bg-black dark:border-primary-500/20">
            <div className="flex items-start gap-3">
              <Info className="h-5 w-5 shrink-0 text-blue-600 mt-0.5" />
              <div className="flex-1">
                <h3 className="mb-2 text-base font-semibold text-blue-900 dark:text-white">How to Export Email</h3>
                <div className="space-y-2 text-sm text-blue-800 dark:text-gray-300">
        ...
        <div className="mb-6 rounded-lg border border-gray-200/20 bg-white/50 hover:bg-white/70 transition-colors p-8 shadow-sm dark:bg-black dark:border-primary-500/20 dark:hover:border-primary-500/30">
          {platform === 'manual' || (!file && !manualText) ? (
            <div className="space-y-4">
              ...
              <div
                ...
                className="cursor-pointer rounded-lg border-2 border-dashed border-gray-300 bg-gray-50/50 p-4 sm:p-8 text-center transition-colors hover:border-primary-400 hover:bg-gray-100/50 dark:bg-black/80 dark:border-gray-600 dark:hover:border-primary-500/40"
              >
                <Upload className="mx-auto mb-2 h-8 w-8 text-gray-400" />
                <p className="text-sm text-gray-600 dark:text-gray-400">Click to upload a file instead</p>
                <input
                  ref={fileInputRef}
                  type="file"
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-4 dark:bg-black dark:border-primary-500/20">
                ...
                <button
                  ...
                  className="rounded-lg p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors dark:hover:bg-primary-900/20 dark:hover:text-gray-300"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
              ...
              {preview && (
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:bg-black dark:border-primary-500/20">
                  <p className="mb-2 text-xs font-semibold text-gray-700 dark:text-gray-300">Preview (first 10 lines):</p>
                  <pre className="max-h-40 overflow-auto rounded bg-white p-3 text-xs text-gray-700 whitespace-pre-wrap font-mono dark:bg-black dark:text-gray-300">
                    {preview}
                  </pre>
                </div>
              )}
            ...
            <div
              onClick={() => fileInputRef.current?.click()}
              className="cursor-pointer rounded-lg border-2 border-dashed border-gray-300 bg-gray-50/50 p-12 text-center transition-colors hover:border-primary-400 hover:bg-gray-100/50 dark:bg-black/80 dark:border-gray-600 dark:hover:border-primary-500/40"
            >
              <Upload className="mx-auto mb-4 h-12 w-12 text-gray-400" />
              <h3 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Upload Chat File</h3>
              <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">Click to select or drag and drop your file</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">Supports: .txt, .csv, .eml (Max 10MB)</p>
              <input
                ref={fileInputRef}
                type="file"
                accept=".txt,.csv,.eml,text/plain,text/csv,message/rfc822"
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-red-200 bg-red-50/50 p-4 sm:p-5 dark:bg-black dark:border-primary-500/20">
            <div className="mb-3 flex items-center gap-2">
              <AlertTriangle className="h-5 w-5 text-red-600" />
              <h3 className="font-semibold text-red-900 dark:text-white">Red Flags Detected</h3>
            </div>
            <ul className="space-y-1 text-sm text-red-800 dark:text-gray-300">
          ...
          <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4 sm:p-5 dark:bg-black dark:border-primary-500/20">
            <div className="mb-3 flex items-center gap-2">
              <FileText className="h-5 w-5 text-blue-600" />
              <h3 className="font-semibold text-blue-900 dark:text-white">Supported Platforms</h3>
            </div>
            <ul className="space-y-1 text-sm text-blue-800 dark:text-gray-300">
        ...
        {/* Privacy Notice */}
        <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50/50 p-4 dark:bg-black dark:border-primary-500/20">
