...
import { ArrowLeft, Shield, Users, Sparkles, Loader2, Eye, EyeOff } from 'lucide-react'
      ...
      <div className="relative z-10 flex flex-col sm:w-1/2">
        ...
        <div className="flex flex-1 flex-col justify-center px-5 py-8 sm:px-10 lg:px-14 sm:bg-white dark:sm:bg-black">
          <div className="mx-auto w-full max-w-md">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white -tracking-[.04em] mb-1 text-center sm:text-left">Create your account</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-7 text-center sm:text-left">Start protecting yourself with Blue Drum AI</p>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center p-10 lg:p-16 h-full text-center">
          <div className="max-w-lg">
            ...
            <p className="mb-8 text-base leading-relaxed text-gray-300 max-w-md mx-auto">
              Join users across India who are proactively documenting evidence, analyzing risks with AI, and building court-ready case files to safeguard their legal rights.
            </p>
            <div className="flex flex-wrap justify-center gap-3">
              {[
                { icon: Sparkles, text: 'AI Risk Analysis' },
                { icon: Shield, text: 'Encrypted Vault' },
                { icon: Users, text: 'Built for Indian Law' },
              ].map(({ icon: Icon, text }) => (
